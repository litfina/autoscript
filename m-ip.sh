...
data_ip="https://raw.githubusercontent.com/litfina/permission/main/seler"
checking_sc() {
...
echo -e "         $COLOR1         ${WH}Telegram: t.me/destiavpnstore    ${NC}"
echo -e "         $COLOR1      ${WH}Whatsapp: wa.me/6281325348667    ${NC}"
echo -e "         $COLOR1╰══════════════════════════════════════════╯${NC}"
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/litfina/permission/main/"
...
REPO="https://github.com/litfina/permission.git"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
    ...
    git remote add origin https://github.com/litfina/permission
    git push -f https://${TOKEN}@github.com/litfina/permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
